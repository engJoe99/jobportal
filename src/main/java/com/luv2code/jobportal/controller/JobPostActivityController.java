...
public class JobPostActivityController {
    ...
    public String searchJobs(Model model,
                             ...
                             @RequestParam(value = "pertTime", required = false) String partTime,
                             ...
                             @RequestParam(value = "day30", required = false) boolean days30
                             ) {
        ...
        if (officeOnly == null && fullTime == null && freelance == null) {
